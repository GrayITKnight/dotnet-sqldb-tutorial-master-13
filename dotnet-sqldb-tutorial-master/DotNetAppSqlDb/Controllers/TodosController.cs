...
namespace DotNetAppSqlDb.Controllers
{
    public class TodosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Description,Test,Done,CreatedDate")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Description,Test,Done,CreatedDate")] Todo todo)
        {
